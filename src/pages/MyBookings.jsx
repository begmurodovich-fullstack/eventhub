...
export default function MyBookings() {
        ...
        <div style={{ display: "flex" }} className="booking-card-inner">
          ...
          <div style={{ width: 140, flexShrink: 0, position: "relative" }}>
            <img
              ...
              onError={(e) => {
                e.target.src = `https://placehold.co/140x140/6C47FF/white?text=Event`;
              }}
            />
            {isCancelled && (
              <div
          ...
          >
            <div>
              ...
              >
                ...
                <span
                  className={`badge ${isCancelled ? "badge-cancelled" : "badge-confirmed"}`}
                >
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
                ...
                >
                  <span>🎟️</span>
                  <span>
                    <strong>{booking.tickets}</strong> ta ticket ·{" "}
  ...
  return (
    <div
      style={{ paddingTop: 72, minHeight: "100vh", background: "var(--bg)" }}
    >
      {/* Header */}
      <div
        style={{
        ...
        {bookings.length === 0 ? (
          <div className="empty-state" style={{ paddingTop: 100 }}>
            ...
            <p style={{ marginBottom: 24 }}>
              Qiziqarli eventlarni toping va birinchi broningizni qiling
            </p>
